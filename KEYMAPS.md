...
| `<leader>fg / fd / fk / fc / f/`           | n    | Grep, diagnostics, keymaps, commands, current-buffer search         |
| `<leader>fw / <leader>fW / <leader>fu`     | n    | Git worktrees, create worktree, undo history                        |
| `<leader>e / <leader>E`                    | n    | Toggle/focus Neo-tree                                               |
| `<S-h> / <S-l>`                            | n    | Previous/next buffer                                                |
| `<leader>bb / bd / bo`                     | n    | Last buffer, delete buffer, delete other buffers                    |
| `<leader>wd / wo / w= / wm`                | n    | Close only/balance/move windows                                     |
| `<leader><tab>n / d / l / h / o`           | n    | New/close/next/prev/only tab                                        |
| `]d / [d / ]e / [e`                        | n    | Next/prev diagnostic and error                                      |
| `<leader>cd / cq / xx / xX / cs`           | n    | Line diagnostics, loclist, Trouble diagnostics/buffer/symbols       |
| `gd / gD / gr / gI / gy`                   | n    | LSP definition, declaration, references, implementations, type defs |
| `K / <C-k>`                                | n    | Hover and signature help                                            |
| `<leader>ca / cr / cA / cf`                | n,x  | Code action, rename, source action, format                          |
| `<leader>cH / <leader>cR`                  | n    | LSP health and restart                                              |
| `<leader>uh`                               | n    | Toggle inlay hints                                                  |
| `]h / [h / <leader>gs / gr / gp / gb / gd` | n,v  | Git hunk navigation and actions                                     |
| `<leader>tt / th / tv`                     | n    | Float, horizontal, vertical terminal                                |
| `<Esc><Esc>`                               | t    | Exit terminal-mode to normal                                        |
| `<leader>rr / re / rE / rv / ri / rb / rB` | n,x  | Refactor menu and extract/inline actions                            |
| `<leader>/`                                | n,x  | Toggle comment                                                      |
| `<leader>zR / zM / za`                     | n    | Open all, close all, toggle folds                                   |
| `<leader>un / ur / ul / uw / us`           | n    | Toggle numbers, relative numbers, listchars, wrap, spell            |
